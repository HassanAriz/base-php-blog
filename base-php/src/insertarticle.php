...
$requete = "INSERT INTO article (title, content, photo) VALUES ('".htmlentities(addslashes($_POST['title']), ENT_QUOTES)."','".htmlentities (addslashes($_POST['content']), ENT_QUOTES)."', '".$_FILES['photo']['name']."')";
